...
const AdvancedTablePage = () => {
  ...
  const { data, isLoading, isError } = useTitlesAPI("/api/titles/?limit=50")
  // DEBUGGING...
...
AdvancedTablePage.pageTitle = `Tabula Rasa: Advanced Table`
AdvancedTablePage.getLayout = getLayout
